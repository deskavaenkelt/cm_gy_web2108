        ...
        test('Expecting a person to be created', (done) => {
            Chai.request(app)
                ...
                .end((error, response) => {
                    ...
                    response.body.should.have.property('name').eq(person.name)
                    response.body.should.have.property('birthPlace').eq(person.birthPlace)
                    done()
                })
        })
    })
        ...
        test('Expecting a person to be updated', (done) => {
            Chai.request(app)
                ...
                .end((error, response) => {
                    ...
                    response.body.should.have.property('name').eq(updatedperson.name)
                    response.body.should.have.property('birthPlace').eq(updatedperson.birthPlace)
                    done()
                })
        })
    })
